...
class FeedPageViewModel : BaseViewModel() {
    ...
    val errorClickLister = View.OnClickListener {
        //에러바 클릭시 처리
    }
    ...
    fun setChangedFeedItem(currentClickState: Boolean, currentStarNum: Int, feedId: String) {
        feedListAdapter.updateFeedItem(currentClickState, currentStarNum, feedId)
    }
    ...
    private fun testInit() {
        ...
        val tempFeed1 = Feed(
            "1",
            "https://img.siksinhot.com/place/1457946348861393.PNG?w=508&h=412&c=Y",
            100,
            "123",
            "1"
        )
        ...
        val tempFeed2 = Feed(
            "2",
            "https://img.siksinhot.com/place/1463988124958100.png?w=508&h=412&c=Y",
            101,
            "123",
            "1"
        )
        ...
        val tempFeed3 = Feed(
            "3",
            "https://img.siksinhot.com/place/1464585331273229.png?w=508&h=412&c=Y",
            102,
            "123",
            "1"
        )
        ...
        val tempFeed4 = Feed(
            "4",
            "https://img.siksinhot.com/place/1530597402238010.jpg?w=508&h=412&c=Y",
            103,
            "123",
            "1"
        )
        ...
        val tempFeed5 = Feed(
            "5",
            "https://img.siksinhot.com/place/1409714449233527.jpg?w=508&h=412&c=Y",
            104,
            "123",
            "1"
        )
        ...
        val tempFeed6 = Feed(
            "6",
            "https://img.siksinhot.com/place/1459317297288889.jpg?w=508&h=412&c=Y",
            11,
            "123",
            "1"
        )
        ...
        val tempFeed7 = Feed(
            "7",
            "https://img.siksinhot.com/place/1457689271606212.PNG?w=508&h=412&c=Y",
            120,
            "123",
            "1"
        )
